...
def load_words():
    with open("E:\\semester 8\\FYP\\Python\\FYP\\Test\\scrape\\English_words.txt") as word_file:
        valid_words = set(word_file.read().split())

    return valid_words

def PK_cities():
    with open("E:\\semester 8\\FYP\\Python\\FYP\\Test\\scrape\\PK.txt") as word_file:
...
def getAuthInfoLink(url, name, out = 0, advanced = False):
    print(url)
    print(name)
...
#                     indexx = r"%r" % i.index("\\")
    ...
    if out == 5:
        print(finalseqlist)
        print(finalreqlist)
    # print(finalreqlist[math.ceil(len(finalreqlist)/2):len(finalreqlist) - math.ceil((len(finalreqlist)/2)/2):])
    # print(finalreqlist)
#     seqlist = finalseqlist
#     reqlist = finalreqlist
    print("Done")
...
# getAuthInfoLink("http://web.uettaxila.edu.pk/EED/faculty.asp#faculty", "UET Taxila", 1)
# getAuthInfoLink("http://ww3.comsats.edu.pk/faculty/FacultyAtoZ.aspx", "comsats", 4)
# getAuthInfoLink("http://web.uettaxila.edu.pk/CS/faculty.asp", "UET Taxila", 4)
getAuthInfoLink("http://web.uettaxila.edu.pk/MED/faculty.asp#faculty", "UET Taxila", 4)